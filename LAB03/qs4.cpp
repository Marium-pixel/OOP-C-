...
Note:  fixed: This manipulator is used to display floating-point numbers in fixed-point notation (i.e., a set number of digits after the decimal point).  setprecision(n): This manipulator sets the number of digits to be displayed after the decimal point. For example, setprecision(1) ensures that only one digit will be displayed after the decimal point, as seen in your angle minutes.*/
...
int main(){
    Location initiallocation(167,45.4,'E');
    cout<<"initial location angle:";
    initiallocation.displaylocation();

    Location userlocation(0,0.0,'N');
    char choice;
    do {
        cout << "\nEnter a new angle:\n";
